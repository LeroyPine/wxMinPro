...
import static com.leroy.wxmin.ProjectConstant.*;
...
public class CodeGenerator {
	// JDBC配置，请修改为你项目的实际配置
	private static final String JDBC_URL = "jdbc:mysql://localhost:3306/home_electric?serverTimezone=UTC&characterEncoding=utf8&useSSL=false";
	...
	public static void main(String[] args) {
		//"exam_paper","ep_questionsn_js","ep_qjs_option","ep_qjs_answer_sheet","ep_courseware","exam_result","exam_result_record"
		//genCode("ep_question","exam_paper","ep_questionsn_select","ep_questionsn_judge","ep_qs_option","ep_qs_answer","ep_qj_answer","ep_courseware","exam_result","exam_result_record");
		//System.out.println(System.getProperty("user.dir"));
		//genCode("exam_paper","ep_questionsn_js","ep_qjs_option","ep_qjs_answer_sheet","ep_courseware","exam_result","exam_result_record");

		//genCode("issus_type","permission","permission_type","project","role","role_permission","state","state_type","user","user_role");
		genCode("admin");
